...
const About = () => {
  return (
    <section
      ...
      style={{
        backgroundImage: `url(https://images.unsplash.com/photo-1444628838545-ac4016a5418a?auto=format&fit=crop&w=800&q=85)`,
    ...
    >
      <style >{`
        @media (min-width: 768px) {
          section {
            background-image: url(https://images.unsplash.com/photo-1444628838545-ac4016a5418a?auto=format&fit=crop&w=1920&q=90) !important;
          }
        }
      `}</style>
